...
DIFFICULTY_LEVELS: dict[int, DifficultyConfig] = {
    0: DifficultyConfig("random", 1, 6, 0.58, 16),
    1: DifficultyConfig("random", 2, 5, 0.54, 14),
    2: DifficultyConfig("heuristic", 2, 4, 0.50, 12),
    3: DifficultyConfig("heuristic", 3, 3, 0.46, 10),
    4: DifficultyConfig("heuristic", 4, 2, 0.42, 8),
    5: DifficultyConfig("mcts", 4, 1, 0.38, 6, ghost_speed=2),
}
